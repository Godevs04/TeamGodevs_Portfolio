    ...
    <Section id="contact" variant="muted">
      <PageContainer>
        ...
        <div className="mb-10 flex flex-wrap items-center justify-center gap-3 md:gap-4">
          ...
          <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2 text-sm font-medium text-foreground shadow-soft">
        ...
        {/* Mode toggle */}
        <div
          className="mx-auto mb-10 flex max-w-md rounded-2xl border border-border bg-card p-1 shadow-soft"
          role="tablist"
