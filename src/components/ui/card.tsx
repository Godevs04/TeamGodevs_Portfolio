...
const cardVariants = cva(
  "rounded-2xl text-card-foreground transition-smooth",
  {
    variants: {
      variant: {
        ...
        glass: "glass-card",
        elevated:
          "border border-border/60 bg-card shadow-medium hover-lift",
        gradient: "border border-border/60 bg-gradient-card shadow-soft",
      },
    },
    defaultVariants: {
      variant: "default",
...
const CardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className={cn("p-6 pt-0 md:p-8 md:pt-0", className)} {...props} />,
);
